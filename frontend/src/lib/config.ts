...
export const MNEE_TOKEN_ADDRESS = getEnv("NEXT_PUBLIC_MNEE_TOKEN_ADDRESS", process.env.NEXT_PUBLIC_MNEE_TOKEN_ADDRESS);
...
export const CONTRACT_ADDRESS = getEnv("NEXT_PUBLIC_CONTRACT_ADDRESS", process.env.NEXT_PUBLIC_CONTRACT_ADDRESS);
